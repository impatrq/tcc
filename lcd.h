...
typedef struct {
    volatile unsigned char*  PORT = &PORTB;  // Pointer to the LCD port e.g &PORTC
    unsigned RS :0;                 // The RS bit of the LCD PORT e.g. 2
    unsigned EN :1;                 // The EN bit of the LCD PORT e.g. 3
    unsigned D4 :2;                 // The D4 bit of the LCD PORT e.g. 4
    unsigned D5 :3;                 // The D5 bit of the LCD PORT e.g. 5
    unsigned D6 :4;                 // The D6 bit of the LCD PORT e.g. 6
    unsigned D7 :5;                 // The D7 bit of the LCD PORT e.g. 7
} LCD;
